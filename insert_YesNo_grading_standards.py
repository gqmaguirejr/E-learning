...
#
# Generate a "grading standard" scale with the names "Yes" and "No" as  "grades".
...
#
# Test with
#  ./insert_YesNo_grading_standards.py -v 11 2 EECS II246X
#  ./insert_YesNo_grading_standards.py -v --config config-test.json 11 2 EECS II246X
# 
#
...
def create_grading_standard(course_or_account, id, name, scale):
       ...
       if r.status_code == requests.codes.ok:
              ...
              return True
       print("Error r.status_code={0}".format(r.status_code))
       return False
...
def main():
       ...
       if (len(remainder) < 1):
              print("Insuffient arguments must provide a course_id|account_id")
              return
